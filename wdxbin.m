...
(* ::Input:: *)
(*Export["samifoF2"<>ToString@year<>".wdx",IfoF2,"wdx"];*)
(*Export["samihmF2"<>ToString@year<>".wdx",IhmF2,"wdx"];*)
(*Export["samiNmF2"<>ToString@year<>".wdx",INmF2,"wdx"];*)
(*Export["samiTEC"<>ToString@year<>".wdx",ITEC,"wdx"];*)
